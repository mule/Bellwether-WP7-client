...
// 
namespace BellwetherClient.Bellwether.Services {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://asp.net/ApplicationServices/v200", ConfigurationName="Bellwether.Services.AuthenticationService")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AuthenticationServiceChannel : BellwetherClient.Bellwether.Services.AuthenticationService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthenticationServiceClient : System.ServiceModel.ClientBase<BellwetherClient.Bellwether.Services.AuthenticationService>, BellwetherClient.Bellwether.Services.AuthenticationService {
        ...
        System.IAsyncResult BellwetherClient.Bellwether.Services.AuthenticationService.BeginValidateUser(string username, string password, string customCredential, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool BellwetherClient.Bellwether.Services.AuthenticationService.EndValidateUser(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginValidateUser(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        private object[] OnEndValidateUser(System.IAsyncResult result) {
            bool retVal = ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).EndValidateUser(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult BellwetherClient.Bellwether.Services.AuthenticationService.BeginLogin(string username, string password, string customCredential, bool isPersistent, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool BellwetherClient.Bellwether.Services.AuthenticationService.EndLogin(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogin(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        private object[] OnEndLogin(System.IAsyncResult result) {
            bool retVal = ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).EndLogin(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult BellwetherClient.Bellwether.Services.AuthenticationService.BeginIsLoggedIn(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginIsLoggedIn(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool BellwetherClient.Bellwether.Services.AuthenticationService.EndIsLoggedIn(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginIsLoggedIn(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).BeginIsLoggedIn(callback, asyncState);
        }
        
        private object[] OnEndIsLoggedIn(System.IAsyncResult result) {
            bool retVal = ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).EndIsLoggedIn(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult BellwetherClient.Bellwether.Services.AuthenticationService.BeginLogout(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogout(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void BellwetherClient.Bellwether.Services.AuthenticationService.EndLogout(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogout(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).BeginLogout(callback, asyncState);
        }
        
        private object[] OnEndLogout(System.IAsyncResult result) {
            ((BellwetherClient.Bellwether.Services.AuthenticationService)(this)).EndLogout(result);
            return null;
        }
        ...
        protected override BellwetherClient.Bellwether.Services.AuthenticationService CreateChannel() {
            return new AuthenticationServiceClientChannel(this);
        }
        
        private class AuthenticationServiceClientChannel : ChannelBase<BellwetherClient.Bellwether.Services.AuthenticationService>, BellwetherClient.Bellwether.Services.AuthenticationService {
            
            public AuthenticationServiceClientChannel(System.ServiceModel.ClientBase<BellwetherClient.Bellwether.Services.AuthenticationService> client) : 
                    base(client) {
            }
